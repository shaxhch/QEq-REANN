...
#edited by shaxh
    ...
    from src.Property_CHA import *
elif start_table==6:
    from src.Property_qeq import *
...
if start_table<=1:
    ...
    import cha.script_PES as PES_Normal
elif start_table==6:
...
if start_table <= 5:
    ...
    Prop_class=Property(getdensity,totcharge,nnmodlist,gausswidth,hardness).to(device).to(torch_dtype)
